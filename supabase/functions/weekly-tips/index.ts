...
Deno.serve(async () => {
  ...
  for (const user of users ?? []) {
    ...
    const subject = "Your Vittarox weekly recap & money tips";

    const html = wrapEmail(`
      <p style="margin:0 0 16px;">Hi ${user.name ?? "there"},</p>
      <p style="margin:0 0 20px;">Here's your weekly recap from Vittarox — a quick look at the last 7 days, plus a few tips to help you make the most of the week ahead.</p>
