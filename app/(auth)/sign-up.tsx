    ...
    return (
      ...
      >
        <View className="flex-1 justify-center px-6 -mt-16">
          <Image
            source={require("../../assets/images/vittarox.png")}
            className="w-36 h-16 mb-8"
            resizeMode="contain"
          />
          <Text
            className="text-3xl font-bold text-[#1A1D26] mb-2
          leading-tight"
          >
            Verify your account
          </Text>
          <Text className="text-brand-text-muted text-base mb-8">
            We sent a code to {signUp.emailAddress || email || "your email"}
          </Text>
            ...
            render={({ field: { value, onChange } }) => {
              return (
                <TextInput
                  ...
                  rounded-x1 px-4 py-3 mb-2 text-[#1A1D26]"
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
            className="w-full bg-brand-blue py-4 rounded-xl
          items-center my-4"
          >
            {isLoading ? (
  ...
  return (
    ...
    >
      <View className="flex-1 justify-center px-6 -mt-16">
            ...
            render={({ field: { value, onChange } }) => {
              return (
                <TextInput
                  ...
                  rounded-x1 px-4 py-3 text-[#1A1D26]"
        ...
        {signUpError && (
          <Text className="text-brand-coral mb-4 text-sm">{signUpError}</Text>
        )}
        <TouchableOpacity
